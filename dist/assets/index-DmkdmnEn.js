(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const t of o)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function s(o){const t={};return o.integrity&&(t.integrity=o.integrity),o.referrerPolicy&&(t.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?t.credentials="include":o.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(o){if(o.ep)return;o.ep=!0;const t=s(o);fetch(o.href,t)}})();function m(){return`
    <header class="header">
  ...
  `}function h(){const e=document.getElementById("header-hamburger"),n=document.getElementById("header-nav");e&&n&&e.addEventListener("click",()=>{n.classList.toggle("header__nav--open"),e.classList.toggle("header__hamburger--open")});const s=document.getElementById("header-hamburger-mobile");s&&n&&s.addEventListener("click",()=>{n.classList.toggle("header__nav--open"),s.classList.toggle("header__hamburger--open")});const r=document.getElementById("know-more-btn-mobile");r&&r.addEventListener("click",()=>{const o=new CustomEvent("showPopup");window.dispatchEvent(o)})}function f(){return`
    <footer class="footer">
  ...
  `}function d(){const e=document.getElementById("popup-form");e&&(e.style.display="flex")}function u(){const e=document.getElementById("popup-form");e&&(e.style.display="none")}function w(){localStorage.setItem("popupFormSubmitted","true")}function k(){return localStorage.getItem("popupFormSubmitted")==="true"}function L(){k()||(c&&clearTimeout(c),c=window.setTimeout(()=>{d()},7e3)),document.addEventListener("click",e=>{const n=e.target;n&&n.id==="close-popup"&&u()}),document.addEventListener("submit",async e=>{const n=e.target;if(n&&n.id==="popup-form-form"){e.preventDefault();const s=document.getElementById("popup-name").value.trim(),r=document.getElementById("popup-phone").value.trim(),o=document.getElementById("popup-city").value.trim(),t=document.getElementById("popup-submit"),a=document.getElementById("popup-success");if(!s||!r||!o)return;t.disabled=!0,t.textContent="Fetching details 🔃";try{const i=new URLSearchParams;i.append("name",s),i.append("phone",r),i.append("city",o),await fetch("https://script.google.com/macros/s/AKfycbyEOKE-d78a95JiaKxRud_vLVhm-9JeaX_d1Y-pvIt8itYWccj1cOGEOT5t9KBWL8aV/exec",{method:"POST",body:i}),w(),a&&(a.style.display="block"),n.style.display="none",setTimeout(()=>{u()},2e3)}catch{t.disabled=!1,t.textContent="Submit",alert("There was an error. Please try again.")}}})}function p(){let e=!1;return typeof window<"u"&&(e=window.innerWidth<=700),`
    <section class="hero-banner">
      <img
        src="${e?"/assets/Value drive POC Website Banner-03.jpg":"/assets/Value drive POC Website Banner-02.jpg"}"
        alt="Value Drive Hero Banner"
        class="hero-banner__img"
      />
    </section>
  `}typeof window<"u"&&window.addEventListener("resize",()=>{const e=document.getElementById("hero");e&&(e.innerHTML=p())});function l(e,n){const s=document.getElementById(e);s&&(s.innerHTML=n)}document.addEventListener("DOMContentLoaded",()=>{const e=["header","hero","know-more","footer-separator","footer","popup"];e.forEach(o=>{if(!document.getElementById(o)){const t=document.createElement("div");t.id=o,document.body.appendChild(t)}});const n=document.body;e.forEach(o=>{const t=document.getElementById(o);t&&n.appendChild(t)}),l("header",m()),h(),l("hero",p()),l("know-more",v());const s=document.getElementById("footer-separator");s&&(s.innerHTML='<hr class="footer-separator" />'),l("footer",f()),l("popup",y()),L();const r=document.getElementById("know-more-btn");r&&r.addEventListener("click",()=>{d()}),window.addEventListener("showPopup",()=>{d()})});
